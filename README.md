...
It mainly uses [Sympy](https://www.sympy.org/en/index.html) and [Python Control Systems Library](https://github.com/python-control/python-control), but, of course, also [Numpy](https://numpy.org/) and [Scipy](https://scipy.org/). 
